...
unsigned char m,n;
unsigned int pauza2,brojac,br1,br2,br3;//deo za frekvenciju prekida tajmera
...
for(br1=5;br1<120;br1++)
{
LcdSetDot (br1,32);
}


for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<16000;pauza++);
...
GLCD_Circle (108,20,10);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<6000;pauza++);
GLCD_Circle (20,44,10);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<6000;pauza++);
GLCD_Circle (108,44,10);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<6000;pauza++);


for(br2=31;br2>0;br2--)
{
GLCD_Circle (64,32,br2);
//for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<1000;pauza++);
}
...
GoToXY(0,0);
GLCD_Rectangle (10,10,100,30);
//for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<16000;pauza++);
GLCD_Rectangle (5,20,70,50);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<16000;pauza++);

GLCD_ClrScr();
GoToXY(0,0);
for(pauza=32;pauza<85;pauza++)
Glcd_PutCharBig (pauza);
for(pauza2=0;pauza2<66;pauza2++)
for(pauza=32;pauza<16000;pauza++);


GLCD_ClrScr();
GoToXY(0,0);
for(pauza=85;pauza<123;pauza++)
Glcd_PutCharBig (pauza);
for(pauza2=0;pauza2<66;pauza2++)
for(pauza=32;pauza<16000;pauza++);
...
GLCD_ClrScr();
GoToXY(0,0);
for(pauza=32;pauza<128;pauza++)
Glcd_PutChar (pauza);
for(pauza2=0;pauza2<66;pauza2++)
for(pauza=32;pauza<16000;pauza++);


for(brojac=0;brojac<64;brojac++)
	{
	LcdSelectSide(LEFT);	
	LcdSelectStartline(brojac);
	for(pauza2=0;pauza2<4;pauza2++)
	for(pauza=32;pauza<600;pauza++);
	LcdSelectSide(RIGHT);	
	LcdSelectStartline(brojac);
	for(pauza2=0;pauza2<4;pauza2++)
	for(pauza=32;pauza<600;pauza++);
...
GLCD_Circle (60,30,20);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<16000;pauza++);


//GoToXY(0,0);
//GLCD_DisplayPicture (bank);
GLCD_DisplayPicture (DISPLAY1_bmp);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<16000;pauza++);
												
//GoToXY(0,0);
GLCD_DisplayPicture (truck);
for(pauza2=0;pauza2<16;pauza2++)
for(pauza=32;pauza<16000;pauza++);
